...
from adapteacher.structures.GModule.graph_config import _C as graph_opt
from adapteacher.structures.GModule.build_graph import PrototypeComputation
...
class GModule(torch.nn.Module):
    ...
    def forward(self, images, features, targets=None, score_maps=None):
        ...
        '''
        if targets:
            features, feat_loss, loss_cont, loss_sink = self._forward_train(images, features, targets, score_maps)
            return features, feat_loss, loss_cont, loss_sink
    ...
    def _forward_train(self, images, features, targets=None, score_maps=None):
        ...
        return features, middle_head_loss, loss_cont, loss_sink
