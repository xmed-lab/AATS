...
from adapteacher.data.detection_utils import build_strong_augmentation, build_middle_augmentation
...
class DatasetMapperTwoCropSeparate(DatasetMapper):
    ...
    def __init__(self, cfg, is_train=True):
        ...
        # add by Lvxg
        self.mid_augmentation = build_middle_augmentation(cfg, is_train)
